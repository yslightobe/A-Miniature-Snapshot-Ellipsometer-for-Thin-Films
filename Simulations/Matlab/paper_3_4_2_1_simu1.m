...
hyper_paras1 = [0.02, 0.01];
hyper_paras2 = [0.02, 0.01, 0., 0, 0]; % 最后两个参数控制是否进行方位角和温度补偿
...
%% 生成样品参数和仿真测量光谱
[M_s, N, C, S] = rcwa_film(wvl/1000,0.03,65); % 微米(行向量)，微米，角度
